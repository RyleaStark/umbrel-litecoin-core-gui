// Litecoin Core's ZMQ block notifiers are silent until the node finishes Initial Block Download
// https://github.com/litecoin/litecoin/blob/31d3eebfb92ae0521e18225d69be95e78fb02672/src/zmq/zmqnotificationinterface.cpp#L150-L158
...
litecoind.events.on('stop', stopBlockSubscriber)
litecoind.events.on('exit', stopBlockSubscriber)

litecoind.events.on('start', () => {
	console.log('[block-subscriber] Litecoind started, starting block subscriber')
